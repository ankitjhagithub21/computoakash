...
export default function Contact() {
  ...
  <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
    ...
    <div className="md:w-1/2 w-full rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
      ...
      <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
        ...
        <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
          ...
          <a href="mailto:computoakash.caic@gmail.com"  className="text-indigo-500 leading-relaxed">computoakash.caic@gmail.com</a>
          <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">
            PHONE
          </h2>
          <p className="leading-relaxed">8210118416, 9973758477</p>
        </div>
      </div>
    </div>
