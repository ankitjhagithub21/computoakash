...
const Reviews = () => {
 ...
 <section className="container mx-auto">
  <div className="text-gray-600 body-font">
    <div className="container px-4 xl:px-32 py-12 mx-auto">
      <h2 className="text-4xl font-semibold title-font text-gray-900 mb-12 text-center dark:text-zinc-100">
        Testimonials
      </h2>
      <div className="flex flex-wrap -m-4">
        <div className="p-4 md:w-1/2 w-full">
          <div className="h-full bg-gray-100 p-8 rounded dark:bg-zinc-800">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              className="block w-5 h-5 text-gray-400 mb-4 dark:text-zinc-500"
            ...
            <p className="leading-relaxed mb-6 dark:text-zinc-300">
            ...
            <span className="inline-flex items-center">
              <span className="flex-grow flex flex-col pl-4">
                <span className="title-font font-medium text-gray-900 dark:text-zinc-100">
                  Mohit Kumar
                </span>
